...
VALUES
(1, 'Jefe de Departamento', 'UASLP', '2015-01-01', '2017-12-31'),
(1, 'Coordinador Académico', 'UASLP', '2018-01-01', '2020-12-31'),
(1, 'Secretario Académico', 'UASLP', '2021-01-01', '2022-12-31'),
(1, 'Director de Área', 'UASLP', '2023-01-01', '2024-12-31'),

(2, 'Coordinador de Carrera', 'UASLP', '2016-01-01', '2018-12-31'),
(2, 'Subdirector', 'UASLP', '2019-01-01', '2020-12-31'),
(2, 'Director', 'UASLP', '2021-01-01', '2022-12-31'),
(2, 'Consejero Académico', 'UASLP', '2023-01-01', '2024-12-31'),

(3, 'Responsable de Laboratorio', 'UASLP', '2014-01-01', '2016-12-31'),
(3, 'Coordinador de Investigación', 'UASLP', '2017-01-01', '2019-12-31'),
(3, 'Secretario Técnico', 'UASLP', '2020-01-01', '2021-12-31'),
(3, 'Jefe de División', 'UASLP', '2022-01-01', '2023-12-31'),

(4, 'Administrador Académico', 'UASLP', '2010-01-01', '2012-12-31'),
(4, 'Jefa de Área', 'UASLP', '2013-01-01', '2015-12-31'),
(4, 'Directora de División', 'UASLP', '2016-01-01', '2018-12-31'),
(4, 'Consejera Académica', 'UASLP', '2019-01-01', '2021-12-31');
...
VALUES
(1, 'Colegio San Luis', 'Profesor de matemáticas', '2005-01-01', '2007-12-31'),
(1, 'Instituto Tecnológico', 'Docente', '2008-01-01', '2010-12-31'),
(1, 'Preparatoria Estatal', 'Coordinador académico', '2011-01-01', '2013-12-31'),
(1, 'Universidad Autónoma', 'Profesor investigador', '2014-01-01', '2015-12-31'),

(2, 'Colegio de Informática', 'Docente', '2006-01-01', '2008-12-31'),
(2, 'Centro de Cómputo', 'Analista', '2009-01-01', '2010-12-31'),
(2, 'Instituto Politécnico', 'Profesor', '2011-01-01', '2013-12-31'),
(2, 'Universidad Autónoma', 'Coordinador de sistemas', '2014-01-01', '2015-12-31'),

(3, 'Colegio Nacional', 'Profesor de Física', '2004-01-01', '2006-12-31'),
(3, 'Laboratorio Nacional', 'Investigador', '2007-01-01', '2009-12-31'),
(3, 'Instituto Tecnológico', 'Profesor titular', '2010-01-01', '2012-12-31'),
(3, 'Universidad Estatal', 'Coordinador de laboratorio', '2013-01-01', '2014-12-31'),

(4, 'Colegio de Negocios', 'Docente', '1998-01-01', '2000-12-31'),
(4, 'Instituto de Gestión', 'Administradora', '2001-01-01', '2003-12-31'),
(4, 'Universidad Nacional', 'Directora de área', '2004-01-01', '2006-12-31'),
(4, 'Centro Académico', 'Consejera académica', '2007-01-01', '2008-12-31');
...
VALUES
(1, 'SEP', 2015, 'Local'),
(1, 'CONACYT', 2017, 'Nacional'),
(1, 'UNESCO', 2019, 'Internacional'),
(1, 'UASLP', 2021, 'Local'),

(2, 'SEP', 2014, 'Local'),
(2, 'CONACYT', 2016, 'Nacional'),
(2, 'UNESCO', 2018, 'Internacional'),
(2, 'UASLP', 2020, 'Local'),

(3, 'SEP', 2013, 'Local'),
(3, 'CONACYT', 2015, 'Nacional'),
(3, 'UNESCO', 2017, 'Internacional'),
(3, 'UASLP', 2019, 'Local'),

(4, 'SEP', 2010, 'Local'),
(4, 'CONACYT', 2012, 'Nacional'),
(4, 'UNESCO', 2014, 'Internacional'),
(4, 'UASLP', 2016, 'Local');
